import KanbanBoard, {moveCard, moveColumn, removeCard, addCard} from '@asseinfo/react-kanban'
...
const BoardPage = () => {
    ...
    const getGradient = (card) => {
        ...
        if (title === "Задолженность") {
            ...
            return {
                background: 
                "linear-gradient(5.35deg, rgba(35, 35, 35, 0.67) -1.72%, rgba(48, 220, 86) 163.54%)",
            }
        } else if (title === "Завершено") {
            return {
                background: 
